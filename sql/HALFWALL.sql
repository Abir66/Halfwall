...
-- ----------------------------
DROP TABLE "HALFWALL"."CHATUSERS";
CREATE TABLE "HALFWALL"."CHATUSERS" (
...
-- ----------------------------
-- Records of CHATUSERS
-- ----------------------------
INSERT INTO "HALFWALL"."CHATUSERS" VALUES ('Saad', 'saad@gmail.com', '1234');
INSERT INTO "HALFWALL"."CHATUSERS" VALUES ('Asif', 'asif@gmail.com', '1234');
...
-- ----------------------------
INSERT INTO "HALFWALL"."CONVERSATIONS" VALUES ('1', '182', TO_TIMESTAMP('2022-08-26 23:21:38.844000', 'SYYYY-MM-DD HH24:MI:SS:FF6'), NULL);
INSERT INTO "HALFWALL"."CONVERSATIONS" VALUES ('2', '180', TO_TIMESTAMP('2022-08-26 23:14:25.166000', 'SYYYY-MM-DD HH24:MI:SS:FF6'), NULL);
INSERT INTO "HALFWALL"."CONVERSATIONS" VALUES ('3', '14', TO_TIMESTAMP('2022-08-15 15:40:33.000000', 'SYYYY-MM-DD HH24:MI:SS:FF6'), NULL);
INSERT INTO "HALFWALL"."CONVERSATIONS" VALUES ('22', '204', TO_TIMESTAMP('2022-08-28 20:26:11.955000', 'SYYYY-MM-DD HH24:MI:SS:FF6'), NULL);
INSERT INTO "HALFWALL"."CONVERSATIONS" VALUES ('23', '203', TO_TIMESTAMP('2022-08-27 20:01:31.787000', 'SYYYY-MM-DD HH24:MI:SS:FF6'), NULL);
...
INSERT INTO "HALFWALL"."POSTS" VALUES ('106', '1', '4', 'abir marketplace 1', TO_TIMESTAMP('2022-08-26 16:32:58.877000', 'SYYYY-MM-DD HH24:MI:SS:FF6'));
...
INSERT INTO "HALFWALL"."POSTS" VALUES ('133', '1', '4', 'post 2', TO_TIMESTAMP('2022-08-28 19:09:55.537000', 'SYYYY-MM-DD HH24:MI:SS:FF6'));
...
-- ----------------------------
INSERT INTO "HALFWALL"."SELL_POSTS" VALUES ('106', 'Electronics', '1000', 'NEW', 'YES');
INSERT INTO "HALFWALL"."SELL_POSTS" VALUES ('133', 'Clothings', '1234', 'Used', 'Yes');
...
-- ----------------------------
CREATE OR REPLACE
FUNCTION "HALFWALL"."SEARCH_PROFILE" AS
BEGIN
	SELECT STUDENT_ID INTO  TEMP FROM USERS WHERE
...
CREATE SEQUENCE "HALFWALL"."CONVERSATION_SEQ" MINVALUE 10 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 CACHE 20;
...
ALTER TABLE "HALFWALL"."FOLLOWS" ADD CONSTRAINT "SYS_C007589" CHECK ("FOLLOWER_ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "HALFWALL"."FOLLOWS" ADD CONSTRAINT "SYS_C007590" CHECK ("FOLLOWEE_ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
...
ALTER TABLE "HALFWALL"."FOLLOW_REQUESTS" ADD CONSTRAINT "SYS_C007591" CHECK ("FOLLOWER_ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "HALFWALL"."FOLLOW_REQUESTS" ADD CONSTRAINT "SYS_C007592" CHECK ("FOLLOWEE_ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
...
ALTER TABLE "HALFWALL"."GROUPS" ADD CONSTRAINT "SYS_C007593" CHECK ("GROUP_ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "HALFWALL"."GROUPS" ADD CONSTRAINT "SYS_C007594" CHECK ("GROUP_NAME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
...
ALTER TABLE "HALFWALL"."GROUP_MEMBERS" ADD CONSTRAINT "SYS_C007597" CHECK ("GROUP_ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "HALFWALL"."GROUP_MEMBERS" ADD CONSTRAINT "SYS_C007598" CHECK ("USER_ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;

-- ----------------------------
-- Primary Key structure for table LIKES
-- ----------------------------
ALTER TABLE "HALFWALL"."MESSAGES" ADD CONSTRAINT "SYS_C007660" PRIMARY KEY ("MESSAGE_ID");

-- ----------------------------
-- Checks structure for table MESSAGES
-- ----------------------------
ALTER TABLE "HALFWALL"."MESSAGES" ADD CONSTRAINT "SYS_C007655" CHECK ("MESSAGE_ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "HALFWALL"."MESSAGES" ADD CONSTRAINT "SYS_C007656" CHECK ("CONVERSATION_ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "HALFWALL"."MESSAGES" ADD CONSTRAINT "SYS_C007657" CHECK ("USER_ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "HALFWALL"."MESSAGES" ADD CONSTRAINT "SYS_C007658" CHECK ("TEXT" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "HALFWALL"."MESSAGES" ADD CONSTRAINT "SYS_C007659" CHECK ("TIMESTAMP" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
...
ALTER TABLE "HALFWALL"."POSTS" ADD CONSTRAINT "SYS_C007601" CHECK ("POST_ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "HALFWALL"."POSTS" ADD CONSTRAINT "SYS_C007602" CHECK ("USER_ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
...
ALTER TABLE "HALFWALL"."USERS" ADD CONSTRAINT "SYS_C007603" CHECK ("USER_ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "HALFWALL"."USERS" ADD CONSTRAINT "SYS_C007604" CHECK ("STUDENT_ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "HALFWALL"."USERS" ADD CONSTRAINT "SYS_C007605" CHECK ("NAME" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "HALFWALL"."USERS" ADD CONSTRAINT "SYS_C007606" CHECK ("EMAIL" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "HALFWALL"."USERS" ADD CONSTRAINT "SYS_C007607" CHECK ("PASSWORD" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
